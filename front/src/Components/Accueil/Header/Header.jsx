    ...
    return (
      <div className="container-div-img">
        <div
          className=""
          style={{
            backgroundImage: `linear-gradient( rgba(255, 255, 255, 0.45), rgba(255, 255, 255, 0.45)), url(${
              header.length > 0 ? header[0].url : ""
            })`,
          }}
        >
          <div className="container div-description-header d-flex justify-content-center">
            <h1 className="text-center mt-5 pt-5">
              {header.length > 0 ? header[0].description : ""}
            </h1>
          </div>
        ...
        <div className="div-vide-savoirFaire"></div>
      </div>
    );
  }
}
