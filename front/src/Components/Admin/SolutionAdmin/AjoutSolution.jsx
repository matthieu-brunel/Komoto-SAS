...
class AjoutsolutionAdmin extends Component{
    ...
    render(){
        ...
        return(
            <div>
                <form>
                    {  this.props.solutionAdmin.length > 0
                    ?
                    ""
                    :
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control " value={this.state.titreSpec} id="titre-spec-admin" type="text" placeholder="titre de la solutionAdmin" onChange={this.handleChangeInput}/>
                    </div>
