            ...
            <div>
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-sm" value={this.state.titreSpec} id="titre-spec-admin" type="text" placeholder="titre de la specialisation" onChange={this.handleChangeInput}/>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div className="d-flex justify-content-between">
                            <div class="form-group">
                                <textarea class="form-control form-control-sm" type="text" value={this.state.addDescription} id="addDescription-spec-admin" onChange={this.handleChangeInput}/>
                            </div>
                            <div class="form-group">
