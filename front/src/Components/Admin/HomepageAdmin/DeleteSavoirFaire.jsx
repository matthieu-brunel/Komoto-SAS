            ...
            <div>
                ...
                <div className="modal-footer">
                    {this.state.checkBox && this.props.SavoirFaireToDelete.length > 0
                        ?
                        <button type="button" className="btn btn-primary" data-dismiss="modal" onClick={this.deleteSavoirFaire}>Enregistrer</button>
                        :
                        <button type="button" className="btn btn-secondary">Enregistrer</button>
                        }
                        <button type="button" className="btn btn-danger" data-dismiss="modal" onClick={this.cancelDeleteSavoirFaire}>Fermer</button>
                </div>
