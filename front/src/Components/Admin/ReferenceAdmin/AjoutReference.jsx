...
class AjoutReference extends Component{
    constructor(props){
        super(props);
        this.state = {
            reference: [],
    ...
    editDescription = (index, event) => {
        ...
        let reference = this.state.specSelected;
        ...
        return(
            <div>
                <form>
                    ...
                    <div class="form-group">
                        <label for="titre-spec-admin">Titre reference</label>
                        <input class="form-control " value={this.state.titreSpec} id="titre-spec-admin" type="text" placeholder="titre de la reference" onChange={this.handleChangeInput}/>
                    </div>
                    ...
                    <div class="custom-file">
                       <input type="file" className="custom-file-input" id="uploadFilereferenceAdmin" onChange={this.handlerUploadFile}/>
                ...
                <div class="modal-footer pt-1">
                    ...
                    <button type="button" class="btn btn-primary" data-dismiss="modal" onClick={this.addNewreference}>Enregistrer</button>
                </div>
